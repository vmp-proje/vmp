...
class MainTabBarController: ESTabBarController, UITabBarControllerDelegate {
  ...
  private func setupTabBar() {
    ...
    let contentView = ExampleIrregularityContentView()
    ...
    homeVC.tabBarItem = ESTabBarItem.init(IrregularityContentView(), title: "Home".localized(), image: nil, selectedImage: nil)
    musicVC.tabBarItem = ESTabBarItem.init(IrregularityContentView(), title: "Music".localized(), image: nil, selectedImage: nil)
    profileVC.tabBarItem = ESTabBarItem.init(IrregularityContentView(), title: "Profile".localized(), image: nil, selectedImage: nil)
